class Item < ApplicationRecord
  ...
  validates :price, numericality: { only_integer: true, greater_than_or_equal_to: 300, less_than_or_equal_to: 999999, message: "is out of setting range" }#, presence: { message: "can't be blank" }
